...
function welcomeLetter(locale: Locale, confirmUrl: string): Letter {
  ...
  const lines = [
    ...
    "",
    "You can also receive the \"Verified creator\" or \"Verified business\" badge. To do so, send additional materials about your work, and we will review them and get back to you.",
    "",
    "Kind regards,",
