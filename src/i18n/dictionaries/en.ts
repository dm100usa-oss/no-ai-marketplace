...
export const en: Dictionary = {
  ...
  pricing: {
    ...
    planFeatures: {
      creator: [
        "A profile page search engines and AI answers actually read",
        "Four signature works, each with the story of how it was made",
        "Work stages beside the portfolio, showing the work is yours",
        "Found under three different categories at once",
      ...
      company: [
        ...
        "A fifth category on top of the team's four",
      ],
    },
    freeNowLabel: "Free right now",
    savePercent: "save {value}%",
    saveAmount: "save {value}",
    plusTitle: "Everything in {plan}, plus",
    recommendedBadge: "We recommend",
    everythingTitle: "In every plan",
    everythingItems: [
      "Direct links to your own platforms: the client pays you directly, no commission",
