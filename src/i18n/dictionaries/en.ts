...
export const en: Dictionary = {
  site: {
    ...
    tagline: "Find talented professionals who work without AI",
  ...
  pricing: {
    ...
    howPaymentText1:
      "After the first 100 places are taken, the join form automatically switches to a paid step. Payment is processed by Stripe — the site never sees or stores your card details. Monthly plans renew each month; yearly plans renew each year. You can cancel at any time.",
    howPaymentText2:
      "No commissions on your sales. No cut of transactions. The site is a listing directory, not a marketplace with in-site payments.",
    readyTitle: "Ready to list?",
    readyText:
      "The first 100 are free — after that, $5.99/month or $49/year.",
    addProfile: "Add your profile",
    readStandards: "Read the standards",
    claimFree: "Claim a free spot",
    getStarted: "Get started",
    planFree: "Free",
    planMonthly: "Monthly",
    planYearly: "Yearly",
    periodFree: "first 100 profiles",
    periodMonthly: "per month",
    periodYearly: "per year",
    yearlyNote: "Save about 32% vs monthly",
    featuresFree: ["Basic profile", "One category", "Limited number of images"],
    featuresMonthly: [
      "Full profile",
      "More images",
      "Multiple categories",
  ...
  join: {
    ...
    periodMonthly: "per month",
    periodYearly: "per year",
    yearlyNote: "Save about 32%",
    fullComparison1: "Full comparison on the ",
    fullComparisonLink: "Pricing",
    fullComparison2: " page.",
