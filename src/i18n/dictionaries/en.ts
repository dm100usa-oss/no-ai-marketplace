...
export const en: Dictionary = {
  ...
  pricing: {
    ...
    planFor: {
      creator: "You work independently",
    ...
    planFeatures: {
      creator: [
        "A professional profile of your own",
        "4 selected works",
        "Listed in 3 categories of the directory",
        "Direct links to your site and social media",
        "Work with clients directly, no commission",
        "Eligible for the Verified creator mark",
      ...
      team: [
        ...
        "Placed above individual creators in the directory",
        "Eligible for the verified profile mark",
        "Free until the end of 2026",
      ],
      company: [
        "Top placement in the directory",
        "A full company page with your logo and services",
        "10 selected projects",
        "Listed in 5 categories of the directory",
        "Eligible for the Verified business mark",
        "Work with clients directly, no commission",
        "Free until the end of 2026",
      ],
    },
    ...
    recommendedBadge: "We recommend",
    everythingTitle: "In every plan",
    everythingItems: [
      "Shown on the home page under New members and New works",
      "Work stages beside your portfolio",
