  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Черновиками и историей документа: видно, как менялась структура, куда автор возвращался, что переписывал. Сгенерированный текст приходит набело. Это второй и третий уровни HTVS. Гильдия авторов США в ноябре 2025 запустила знак Human Authored для книг, его можно получить и поставить в профиль.",
        links: [{ label: "Как устроен метод HTVS", href: "/method" }],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Черновиками и историей документа. Плюс знак Human Authored от Гильдии авторов США, если книга на английском: его ставят на обложку, и он проверяется в открытой базе.",
        links: [{ label: "Как устроен метод HTVS", href: "/method" }],
      },
    ],
  },
    ...
    items: [
      {
        ...
        a: "Здесь. Профиль ведет на ваш сайт и портфолио, заказчики связываются напрямую, комиссии нет.",
        links: [
          { label: "Добавить профиль", href: "/join" },
      ...
      },
      {
        ...
        a: "Черновиками и историей документа: поэтапная структура, синопсис, поэпизодник, версии. Это второй и третий уровни HTVS. В кино с 2026 года есть еще знак Human Made Mark, который выдают проектам после проверки документов производства.",
        links: [{ label: "Как устроен метод HTVS", href: "/method" }],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "With drafts and document history: you can see the structure shifting, the places you went back to, what you rewrote. Generated text arrives clean. Those are levels two and three of HTVS. The Authors Guild launched its Human Authored mark for books in November 2025, and you can earn it and show it on your profile.",
        links: [{ label: "How HTVS works", href: "/method" }],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Drafts and document history. Plus the Authors Guild Human Authored mark if the book is in English: it goes on the cover and is checkable in a public database.",
        links: [{ label: "How HTVS works", href: "/method" }],
      },
    ],
  },
    ...
    items: [
      {
        ...
        a: "Here. Your profile links to your site and portfolio, clients contact you directly, and there is no commission.",
        links: [
          { label: "Add your profile", href: "/join" },
      ...
      },
      {
        ...
        a: "Drafts and document history: the staged structure, the synopsis, the beat sheet, the versions. Those are levels two and three of HTVS. In film there is also the Human Made Mark, launched in 2026, awarded to productions after their paperwork is reviewed.",
        links: [{ label: "How HTVS works", href: "/method" }],
      },
      {
