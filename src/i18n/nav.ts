  ...
  return [
    ...
    },
    {
      ...
      links: [
        ...
        { label: dict.footer.workStages, href: "/work-stages" },
        { label: dict.footer.verifiedProfiles, href: "/verified" },
      ],
    },
    {
      title: dict.footer.ourApproach,
      links: [
        { label: dict.footer.knowledge, href: "/knowledge" },
        { label: dict.footer.howToVerify, href: "/how-to-verify" },
        { label: dict.footer.originCheck, href: "/origin-check" },
